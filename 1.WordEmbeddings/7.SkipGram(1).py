# [MXNLP-1-05] 7.SkipGram(1).py
# Implementation of a Skip-Gram model using two output layers
#
...
y1_out = Dense(n_vocab, activation='softmax')(x_emb)    # (None, 51420)
y2_out = Dense(n_vocab, activation='softmax')(x_emb)    # (None, 51420)

model = Model(x_input, [y1_out, y2_out])
